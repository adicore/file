function pagination(a) {
    ...
    postnumber > 1 && (e += 2 == postnumber ? "page" == type ? '<span class="showpage"><a href="' + home_page + '">' + prevpage + "</a></span>" : '<span class="page-item"><a href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">' + prevpage + "</a></span>" : "page" == type ? '<span class="page-item"><a class="page-link"  href="#" onclick="redirectpage(' + s + ');return false">' + prevpage + "</a></span>" : '<span class="page-item"><a href="#" onclick="redirectlabel(' + s + ');return false">' + prevpage + "</a></span>"), start > 1 && (e += "page" == type ? '<span class="page-item"><a href="' + home_page + '">1</a></span>' : '<span class="page-item"><a href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></span>'), start > 2 && (e += "");
    for (var r = start; r <= end; r++) e += postnumber == r ? '<span class="active">' + r + "</span>" : 1 == r ? "page" == type ? '<span class="page-item"><a href="' + home_page + '">1</a></span>' : '<span class="page-item"><a href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '">1</a></span>' : "page" == type ? '<span class="page-item"><a class="page-link"  href="#" onclick="redirectpage(' + r + ');return false">' + r + "</a></span>" : '<span class="page-item"><a href="#" onclick="redirectlabel(' + r + ');return false">' + r + "</a></span>";
    end < maximum - 1 && (e += ""), end < maximum && (e += "page" == type ? '<span class="page-item"><a class="page-link"  href="#" onclick="redirectpage(' + maximum + ');return false">' + maximum + "</a></span>" : '<span class="page-item"><a href="#" onclick="redirectlabel(' + maximum + ');return false">' + maximum + "</a></span>");
    var n = parseInt(postnumber) + 1;
    postnumber < maximum && (e += "page" == type ? '<span class="page-item"><a class="page-link"  href="#" onclick="redirectpage(' + n + ');return false">' + nextpage + "</a></span>" : '<span class="page-item"><a href="#" onclick="redirectlabel(' + n + ');return false">' + nextpage + "</a></span>");
