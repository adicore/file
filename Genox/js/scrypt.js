var NioApp = function(a, e, s) {
    ...
    function o(e) {
        e = void 0 === e ? a : e, i.docReady.concat(i.docReadyDefer).forEach(function(a) {
            a(e)
        })
    }

    function n(e) {
        e = "object" == typeof e ? a : e, i.winLoad.concat(i.winLoadDefer).forEach(function(a) {
            a(e)
        })
    }
...
NioApp = function(f, b, d, n) {
    ...
    b.fn.exists = function() {
    ...
    }, f.components.docReady.push(f.Util.classInit), f.Util.preLoader = function() {
        var a = b(".preloader"),
            e = b(".spinner");
        a.exists() && (l.addClass("page-loaded"), e.addClass("load-done"), a.delay(600).fadeOut(300))
    }, f.components.winLoad.push(f.Util.preLoader), f.Util.backTop = function() {
        var a = b(".backtop");
        if (a.exists()) {
            800 < c.scrollTop() ? a.fadeIn("slow") : a.fadeOut("slow"), a.on("click", function(a) {
                b("body,html").stop().animate({
                    scrollTop: 0
                }, 1500, "easeInOutExpo"), a.preventDefault()
            })
        }
    }, f.components.docReady.push(f.Util.backTop), f.Util.headerSearch = function() {
    ...
    }, f.components.docReady.push(f.Util.headerSearch), f.Util.browser = function() {
    ...
    }, f.components.winLoad.push(f.Util.browser), f.Util.headerSticky = function() {
        var e = b(".is-sticky"),
            a = {
                hasFixed: function() {
                    if (e.exists()) {
        ...
        a.hasFixed(), a.hasShrink(), c.on("resize", function() {
            i = e.hasClass(t) ? h.height() + 16 - 2 : h.innerHeight() - 2
        })
    }, f.components.docReady.push(f.Util.headerSticky), f.Util.imageBG = function() {
        var a = b(".bg-image");
        a.exists() && a.each(function() {
            var a = b(this),
                ...
                o = !(void 0 === s || !s) && s,
                n = !(void 0 === t || !t) && t;
            void 0 !== i && "" !== i && (e.hasClass("has-bg-image") || e.addClass("has-bg-image"), o ? a.hasClass("overlay-" + o) || (a.addClass("overlay"), a.addClass("overlay-" + o)) : a.hasClass("overlay-fall") || a.addClass("overlay-fall"), n && a.addClass("overlay-opacity-" + n), a.css("background-image", 'url("' + i + '")').addClass("bg-image-loaded"))
        })
    }, f.components.docReady.push(f.Util.imageBG), f.Util.Ovm = function() {
        var a = b(".nk-ovm"),
            e = b(".nk-ovm[class*=mask]");
        a.exists() && a.each(function() {
    ...
    }, f.components.docReady.push(f.Util.Ovm), f.Util.toggler = function() {
        var t = ".toggle-tigger",
            i = ".toggle-class";
        b(t).exists() && p.on("click", t, function(a) {
            var e = b(this);
            b(t).not(e).removeClass("active"), b(i).not(e.parent().children()).removeClass("active"), e.toggleClass("active").parent().find(i).toggleClass("active"), a.preventDefault()
        }), p.on("click", "body", function(a) {
            var e = b(t),
                s = b(i);
            s.is(a.target) || 0 !== s.has(a.target).length || e.is(a.target) || 0 !== e.has(a.target).length || (s.removeClass("active"), e.removeClass("active"))
        })
    }, f.components.docReady.push(f.Util.toggler), f.Util.accordionActive = function() {
    ...
    }, f.components.docReady.push(f.Util.accordionActive), f.Util.scrollAnimation = function() {
        var a = b(".animated");
        b().waypoint && a.exists() && a.each(function() {
            var a = b(this),
                ...
                t = a.data("delay");
            a.waypoint(function() {
                a.addClass("animated " + e).css("visibility", "visible"), s && a.css("animation-duration", s + "s"), t && a.css("animation-delay", t + "s")
            }, {
                offset: "93%"
            })
        })
    }, f.components.winLoad.push(f.Util.scrollAnimation), f.Util.Counter = function() {
        var a = b(".count"),
            e = b(".count").attr("data-count");
        b().waypoint && a.exists() && a.each(function() {
            a.waypoint(function() {
                a.counter({
                    duration: 2e3,
    ...
    }, f.components.winLoad.push(f.Util.Counter), f.Util.sliderAnimation = function() {
        var a = b(".animate");
        a.exists() && a.each(function() {
            var a = b(this),
                e = a.data("animate"),
    ...
    }, f.components.winLoad.push(f.Util.sliderAnimation), f.MainMenu = function() {
        var e = b(".navbar-toggle"),
            ...
            a = {
                ...
                navToggle: function() {
                    e.exists() && e.on("click", function(a) {
                        var e = b(this),
                            s = e.data("menu-toggle");
                        e.toggleClass("active"), t.exists() ? b("#" + s).slideToggle().toggleClass(r) : b("#" + s).parent().toggleClass(r), a.preventDefault()
                    })
                },
                navClose: function() {
                ...
                currentPage: function() {
                    ...
                    o.exists() && o.each(function() {
                        a === this.href && b(this).closest("li").addClass("active").parent().closest("li").addClass("active")
                    })
                }
            };
        a.Overlay(), a.navToggle(), a.navClose(), a.menuToggle(), a.mobileNav(), a.currentPage(), c.on("resize", function() {
            a.mobileNav()
        })
    }, f.components.docReady.push(f.MainMenu), f.OnePageScroll = function() {
        b('a.menu-link[href*="#"]:not([href="#"])').on("click", function() {
            if (location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
                var a = this.hash,
                    e = !!this.hash.slice(1) && b("[name=" + this.hash.slice(1) + "]"),
                    s = a.length ? b(a) : e;
                if (s.length) return b(".navbar-toggle").removeClass("active"), b(".header-navbar").removeClass("menu-shown"), b("html, body").delay(150).animate({
                    scrollTop: s.offset().top - i
                }, 1e3, "easeInOutExpo"), !1
            }
        })
    }, f.components.docReady.push(f.OnePageScroll), f.scrollAct = function() {
        l.scrollspy({
            target: "#header-menu",
            offset: i + 2
        })
    }, f.components.docReady.push(f.scrollAct), f.Plugins = {}, f.Plugins.carousel = function() {
        ...
        a.exists() && a.each(function() {
            var a = b(this),
                ...
                g = b(".slick-next"),
                v = b(".slick-prev");
            1 === e && (s = t = 1), !0 === p && b(".tes-arrow").addClass("active"), a.slick({
                autoplay: r,
                autoplaySpeed: o,
                speed: n,
                centerMode: h,
    ...
    }, f.components.winLoad.push(f.Plugins.carousel), f.Plugins.select2 = function() {
        var a = b(".select");
        a.exists() && a.each(function() {
            var a = b(this),
                e = a.data("select2-theme") ? a.data("select2-theme") : "bordered",
                s = a.data("select2-placehold") ? a.data("select2-placehold") : "Select an option";
            a.select2({
                placeholder: s,
                theme: "default select-" + e
            })
        })
    }, f.components.docReady.push(f.Plugins.select2), f.Plugins.validform = function() {
        var a = b(".form-validate");
        if (!b().validate) return console.log("jQuery Form Validate not Defined."), !0;
        a.exists() && a.each(function() {
            var a = b(this);
    ...
    }, f.components.docReady.push(f.Plugins.validform), f.Plugins.submitform = function() {
        var a = b(".genox-form");
        if (!b().validate && !b().ajaxSubmit) return console.log("jQuery Form and Form Validate not Defined."), !0;
        a.exists() && a.each(function() {
            var a = b(this),
                t = a.find(".form-results");
            a.validate({
                ignore: [],
                ...
                submitHandler: function(s) {
                    t.slideUp(400), b(s).ajaxSubmit({
                        target: t,
                        dataType: "json",
                        success: function(a) {
                            var e = "error" === a.result ? "alert-danger" : "alert-success";
                            t.removeClass("alert-danger alert-success").addClass("alert " + e).html(a.message).slideDown(400), "error" !== a.result && b(s).clearForm().find("input").removeClass("input-focused")
                        }
                    })
                }
    ...
    }, f.components.docReady.push(f.Plugins.submitform), f.Plugins.popup = function() {
        ...
        t.content_popup(), t.video_popup(), t.image_popup()
    }, f.components.docReady.push(f.Plugins.popup), f.Plugins.twitterfeed = function() {
        var a = "tweets_feed";
        if (b("#" + a).exists()) {
            var e = {
                profile: {
    ...
    }, f.components.winLoad.push(f.Plugins.twitterfeed), f.Plugins.datepicker = function() {
        b(".datepicker").datepicker()
    }, f.components.winLoad.push(f.Plugins.datepicker), f.Plugins.lineanimate = function() {
        b(".line-animate").addClass("active")
    }, f.components.winLoad.push(f.Plugins.lineanimate), f.Plugins.filterz = function() {
        var a = b(".project"),
            e = b(".project-filter li");
        a.each(function() {
            var a = b(this),
                e = a.data("layout") ? a.data("layout") : "packed";
            b(this).filterizr({
                layout: e
            })
        }), e.on("click", function() {
            e.removeClass("active"), b(this).addClass("active")
        })
    }, f.components.winLoad.push(f.Plugins.filterz), f.Plugins.videoBG = function() {
        var a = b(".bg-video");
        a.exists() && a.each(function() {
            var a = b(this),
                e = a.parent(),
        ...
        0 < i.length && i.on("click", function(a) {
            var e = b(this),
                s = e.attr("title"),
                t = b(".change-bg");
            if (e.hasClass("current")) return !1;
            i.removeClass("current"), e.addClass("current"), b("body").fadeOut(function() {
