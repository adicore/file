...
$(document).ready(function () {
	function b() {
		...
		g = $("#ContactForm1 .contact-form-company").val(),
		k = $("#ContactForm1 .formnamemessage .form2msg").val(),
		h = "",
	...
	$("#glb-raintemplates").on("click", ".btnreserva", function (a) {
		...
		$("#ContactForm2 .contact-form-widget").appendTo(".contact-form-wrapper");
	...
	$("button.close").click(function () {
		$(".contact-form-wrapper .contact-form-widget").appendTo("#ContactForm2");
		$(".overlay").css({
			height: "2px",
			top: "50%"
		});
